...
const I18N_EN = {
  ...
  cas_intro:"Our first tools were born in energy renovation — a sector demanding in volume and compliance. The same building blocks (file reviews, automatic controls, reminders, specialized agents) are the ones we deploy in accounting firms.",
  ...
  par_eyebrow:"Track record",
  par1_d:"15 years", par1_t:"SAP Finance (FI/CO)", par1_p:"Optimizing the finance processes of large French and international groups.",
  par2_d:"S/4HANA", par2_t:"Data migrations", par2_p:"Converting and securing financial data at very large scale.",
  par3_d:"2026", par3_t:"Atomea", par3_p:"The same rigor, augmented by AI, now serving accounting firms and SMEs.",
