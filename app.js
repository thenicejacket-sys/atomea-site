...
const I18N_EN = {
  ...
  faqcta_p:"A free 30-minute conversation, no strings attached — we answer it live and spot your first automation gains along the way.",
  faqcta_btn:"Let's talk",
  ...
  sec_ener_eyebrow:"Energy renovation & EEC", sec_ener_title:"A demanding sector, measured gains.",
  sec_pme_eyebrow:"SMEs & productivity", sec_pme_title:"Tools that serve any company.",
  ...
  app1_tag:"Custom app", app1_t:"Sports coaching app", app1_p:"A complete coaching app: programs, session tracking and a real-time AI voice coach guiding the user.", app1_r:"An app shipped end to end — AI voice, real time, polished UX",
  app2_tag:"Voice assistant / IoT", app2_t:"Home voice assistant", app2_p:"A voice-driven assistant: natural-language commands, connected-device and API integration, orchestration of specialized agents.", app2_r:"The same building blocks — voice, integrations, agents — that power a business assistant",
  cas1_tag:"Energy renovation", cas1_t:"Reliable project reviews", cas1_p:"Custom project review and pre-costing application: faster file analysis, safer commitment decisions.", cas1_r:"Analyzing a file goes from hours to minutes — and far fewer errors",
  cas2_tag:"Energy renovation", cas2_t:"Audit quality control", cas2_p:"Automated audit comparison and control tool: inconsistencies and deviations detected systematically.", cas2_r:"30–45 min saved per file, on 20–30 files every month — ≈ 10% of a full-time role freed up",
  ...
  cas6_tag:"Accounting firms", cas6_t:"What about your firm?", cas6_p:"File reviews, systematic checks, automatic reminders: these tools in production are exactly what an accounting firm's production needs. We adapt them to your working files.", cas6_r:"Discover the accounting-firm offer →",
  ab_eyebrow:"About us",
  ...
  rb3_t:"What I build", rb3_p:"Custom applications designed and shipped end to end, from a sports-coaching app to a voice assistant — proof that I ship, not just advise.",
