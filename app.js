...
const I18N_EN = {
  ...
  hero_title:"Helping companies move from their current state to their <em>ideal state</em>",
  hero_sub:"Diagnosis, automation, custom-built tools, training: Atomea makes transformation concrete, useful and profitable — whatever the size of your business.",
  ...
  mi_eyebrow:"Our conviction",
  mi_text:"Your business <span class='to'>augmented</span> by automation, artificial intelligence and a redesigned organization.",
